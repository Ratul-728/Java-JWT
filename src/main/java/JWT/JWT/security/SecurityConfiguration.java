...
import JWT.JWT.filter.CustomAuthenticationFilter;
import JWT.JWT.filter.CustomAuthorizationFilter;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers(GET, "/api/get-user").hasAnyAuthority("ROLE_USER");
